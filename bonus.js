  ...
  http.createServer(            //Creates the response loop
    (req,res)=> {               //Anonymous function to handle the request
      ...
      if (req.method === 'GET' ) {
          ...
          res.write("Your quotes: ")
          var quotes = ["You can totally do this.", "Don’t tell people your plans. Show them your results.", "sugarNo pressure, no diamonds.", "Stay foolish to stay sane.", "When nothing goes right, go left.", "Try Again. Fail again. Fail better."];
